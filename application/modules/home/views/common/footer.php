    ...
    <div class="container">
        <div class="row py-4">
            ...
            <div class="col">
                ...
                <p class="mb-1">Hyderabad, 500033.</p>
            </div>
        </div>
    </div>
    <div class="py-2" style="background: #2a3035!important; font-size: 12px;">
        <div class="container text-right">Designed & Developed By Narendra</div>
    </div>
    <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js" integrity="sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49" crossorigin="anonymous"></script>
    <script src="<?= root; ?>assets/bootstrap4/js/bootstrap.min.js" crossorigin="anonymous"></script>
    <script src="https://use.fontawesome.com/5c50d0e8ff.js"></script>
</footer>
